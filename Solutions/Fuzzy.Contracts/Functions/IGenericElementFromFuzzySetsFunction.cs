// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IGenericElementFromFuzzySetsFunction.cs" company="I9 Tecnologia da Informação">
...
namespace Fuzzy.Contracts.Functions
{
    ...
    /// </summary>
    public interface IGenericElementFromFuzzySetsFunction
    {
        /// <summary>
        ...
        IFuzzyElement Execute(List<IFuzzySet> values);
    }
}
